...
class CCPayment_Client
{
    ...
    const PayStatusSuccess = 'Paid';
    const PayStatusUnderpaid = 'Underpaid';
    const PayStatusOverpaid = 'Overpayed';
    const PayStatusFailed = 'Failed';
    const PayStatusExpired = 'Expired';
    const PayStatusExpiredUnderpaid = 'ExpiredUnderpaid';
